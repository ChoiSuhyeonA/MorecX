...
function overColor(tr_id) {
	if(document.getElementById("tr_"+tr_id).style.backgroundColor != "#eef7fa") {
		document.getElementById("tr_"+tr_id).style.backgroundColor = "#e0f5f5";
	}
}

function outColor(tr_id) { 
	if(document.getElementById("tr_"+tr_id).style.backgroundColor != "#eef7fa") {
		document.getElementById("tr_"+tr_id).style.backgroundColor = "#ffffff";
	}
}
...
var old_tr_id = "";
var old_tr_bgcolor = "";
function changeLine(strKey, tr_id) 
{
		if(old_tr_id != "") {
			document.getElementById("tr_" + old_tr_id).style.backgroundColor = "#ffffff";
		}
		if(strKey != "") {
...
var old_tr_id2 = "";
var old_tr_bgcolor2 = "";
function changeLine2(strKey, tr_id) 
{
		...
		if(strKey != "") {
			...
			document.getElementById("tr_" + tr_id + "L").style.backgroundColor = "#eef7fa";
			document.getElementById("tr_" + tr_id + "R").style.backgroundColor = "#eef7fa";
			old_tr_id2 = tr_id;
		}
}
...
/* 전화번호 '-' */
function fn_get_phone_format(strPhoneNo) {
	var strReturnValue = "";
	strReturnValue = strPhoneNo.replaceAll(" ", "");
	
	if(strReturnValue.length > 4){
		if (strReturnValue.substring(0,2) == "02"){
		...
		}else if (strReturnValue.substring(0,3) == "031"){
		...
		}else if (strReturnValue.substring(0,3) == "032"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "033"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "041"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "042"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "043"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "051"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "052"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "053"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "054"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "055"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "061"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "062"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "063"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "064"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "010"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "011"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "016"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "017"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "018"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "019"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "070"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
			}
		}else if (strReturnValue.substring(0,3) == "080"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-" +   strReturnValue.substring(7,strReturnValue.length);  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-" +   strReturnValue.substring(6,strReturnValue.length);
...
/* 전화번호 마스킹처리 '**' */
function fn_get_phone_masking_format(strPhoneNo) {
	if($("#hidPhoneNumberShowFlag").val()=='N' || parent.$("#hidPhoneNumberShowFlag").val()=='N'){
		return fn_get_phone_format(strPhoneNo);
	}
	var strReturnValue = "";
	strReturnValue = strPhoneNo.replaceAll(" ", "");
	...
	if(strReturnValue.length > 4){
		if (strReturnValue.substring(0,2) == "02"){
			if(strReturnValue.length >= 10){
				strReturnValue = strReturnValue.substring(0,2) + "-" + strReturnValue.substring(2,6) + "-****";  
			}else{
				strReturnValue = strReturnValue.substring(0,2) + "-" +  strReturnValue.substring(2,5) + "-****";
			}
		}else if (strReturnValue.substring(0,3) == "031"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-****";  
			}else{
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,6) + "-****";
			}
		}else if (strReturnValue.substring(0,3) == "032"){
			if(strReturnValue.length >= 11){
				strReturnValue = strReturnValue.substring(0,3) + "-" +  strReturnValue.substring(3,7) + "-****";  
			...
			strReturnValue = strReturnValue.substring(0,3) + "-****";
		}else{
			strReturnValue = strReturnValue.substring(0,4) + "-***";
		}
	}else{
		strReturnValue = strPhoneNo;
	}
