...
function init(){	
	...
	//추가 
	$("#pageType").val( win.$("#pageType").val() ); 
	$("#searchGroupName").val ( win.$("#schGroupName").val() );
	$("#searchGroupSeq").val ( win.$("#schGroupId").val() );
...
function searchUserList(){
	...
	$("#cmnUserSearchVO").attr("action","<c:url value='/common/selectUserList.do'/>");
...
<!-- 추가  -->
<input type="hidden" id="searchGroupName" name="searchGroupName" value="" />
<input type="hidden" id="searchGroupSeq" name="searchGroupSeq" value="" />
