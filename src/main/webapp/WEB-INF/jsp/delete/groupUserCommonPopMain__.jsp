...
function searchGroupList(){
	...
	$("#cmnGroupSearchVO").attr("action","<c:url value='/common/selectGroupUserList.do'/>");
	$("#cmnGroupSearchVO").submit();
}

function setParam() {
	
	alert(win.$("#groupPopSubCheck").val());
	if(!win.$("#groupPopSubCheck").val()){
