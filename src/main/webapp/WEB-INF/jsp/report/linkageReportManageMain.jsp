...
function fnc_init(){
	...
	$("#reportSearchVO").attr("action","<c:url value='/report/linkageReportManageInitList.do'/>");
...
function searchList(){
	...
	if($('#orderKey').val() == '')
		sortField('');
	$("#reportSearchVO").attr("target","iframeReportList");
	$("#reportSearchVO").attr("action","<c:url value='/report/linkageReportManageList.do'/>");
	$("#reportSearchVO").submit();
}
...
function searchReportListExcel(){
	...
	if($('#orderKey').val() == '')
		sortField('');
	$("#reportSearchVO").attr("target","iframeReportList");
	$("#reportSearchVO").attr("action","<c:url value='/report/linkageReportManageListExcel.do'/>");
	$("#reportSearchVO").submit();
}
			...
			<td colspan="3">
				...
				<tr>
					...
					<td style="padding-top:1px;">
						<img height="33px" border="0px" src="<c:url value='/images/title/title_report.gif' />" />
					</td>
					<td></td>
				</tr>
				</table>
