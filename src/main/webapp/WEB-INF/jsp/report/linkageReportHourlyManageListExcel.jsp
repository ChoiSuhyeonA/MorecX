<%-- 
- 페이지 제목 : 콜통계
- 페이지 ID : reportHourlyManageListExcel.jsp
- 저작권 : ㈜ 아이알링크
- 작성자 : 김정철
- 작성일자 : 2013-09-12
...
<%
	...
	response.setHeader("Content-Disposition","attachment;filename=ReportHourlyManageList.xls");
...
<tr>
	...
	<td style="mso-number-format:'\@'"><c:out value="${result.id}" /></td>
