<%-- 
- 페이지 제목 : 통화길이별콜통계
- 페이지 ID : reportDurationManageCampaignListExcel.jsp
- 저작권 : ㈜ 아이알링크
- 작성자 : 김정철
- 작성일자 : 2013-09-04
...
<%
	...
	response.setHeader("Content-Disposition","attachment;filename=ReportDurationManageCampaignList.xls");
...
<tr><td align="center" colspan="20"><spring:message code='common.nodata.message' /></td></tr>
</c:if>
<c:choose>
...
<tr bgcolor="#aaaaaa"  height="25px">
		<td colspan="2" align="center"><spring:message code='message.sum' /></td>
